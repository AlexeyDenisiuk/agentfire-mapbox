			...
			<div class="row mt-3 mb-3">
				<div class="col">
					<div class="select-cont">
						...
						<select id="filters_map_marker_tags" name="tags[]" class="agfm-select" style="width: 100%;" multiple="multiple" placeholder="<?=Helpers::__( 'Select a tag' )?>">
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
		    <div class="modal-content">
				<div class="modal-header border-white">
					<h5 class="modal-title"><?=Helpers::__( 'Add marker' )?></h5>
				</div>
						...
						<form>
							...
							<div class="row mt-3 mb-3">
								<div class="col">
									<div class="select-cont">
										<!-- style="width: 100%;" - this is by Select2 owners manual to make it responsive -->
										<select class="agfm-select form-control" style="width: 100%" multiple="multiple" placeholder="<?=Helpers::__( 'Select a tag' )?>">
											<?php foreach ( $tmpl['map_marker_tags'] as $tag ) { ?>
												<option value='<?=$tag->term_id?>'><?=$tag->name?></option>
											<?php } ?>
										</select>
									</div>
									<div class="invalid-feedback"><?=Helpers::__( 'Choose a tag please' )?></div>
								</div>
							</div>
						</form>
					</div>
				...
				<div class="modal-footer border-white">
					<button type="button" id="map_marker_add_btn" class="btn btn-primary"><?=Helpers::__( 'Add' )?></button>
					<button type="button" id="map_marker_cancel_btn" class="btn btn-light bg-white border-white shadow-none" data-dismiss="modal"><?=Helpers::__( 'Cancel' )?></button>
				</div>
		    </div>
		</div>
	</div>
